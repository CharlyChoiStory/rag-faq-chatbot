    ...
    input: [
      {
        ...
        content: [
          ...
          "- 단, 금액, 기한, 신청 메뉴명, 담당 부서, 예외 조건 같은 핵심 사실은 원문과 다르게 바꾸지 마세요.",
      ...
      },
      {
        ...
        content: [
          ...
          "검색 원문을 그대로 나열하지 말고, 사용자가 해야 할 행동 중심으로 재구성하세요.",
